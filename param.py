...
def add_args(parse=True, **optional_kwargs):
    ...
    # Model Config
    parser.add_argument('--backbone', type=str, default='/data/share/Llama-3-8B-instruct/')

    # Training
    parser.add_argument('--batch_size', type=int, default=1, help='train batch size of per device')
